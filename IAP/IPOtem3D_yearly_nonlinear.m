...
load("MatFile\Tempadnlf.mat"); % detrended and 8-yr filtered temperature
Tempadnlf(:,:,:,1:4) = []; Tempadnlf(:,:,:,end-3:end) = []; 
...
print(Fig,['E:\figures\IAP\Yearly\8yrs_nonlinearDetrend\Indian_Pacific_Atlantic.png'],'-dpng','-r600')
%% longitude mean (zonal mean)
% Indian Ocean
lonmI1 = permute(nanmean(Tempadnlf(40:100,83:116,:,:),1),[2 3 4 1]); % 40E-100E, 8S-25N
lonmI2 = permute(nanmean(Tempadnlf(20:146,20:82,:,:),1),[2 3 4 1]);
...
print(Fig,['E:\figures\IAP\Yearly\8yrs_nonlinearDetrend\IPO.corr.Indian.zonalmean.tem.png'],'-dpng','-r600')
%% Pacific 
lonmP1 = permute(nanmean(Tempadnlf(146:293,20:82,:,:),1),[2 3 4 1]); % 146E-67W, 70S-8S
lonmP2 = permute(nanmean(Tempadnlf(100:293,83:101,:,:),1),[2 3 4 1]); % 100E-67W, 8S-10N
lonmP3 = permute(nanmean(Tempadnlf(100:270,102:109,:,:),1),[2 3 4 1]); % 100E-90W, 10N-18N
lonmP4 = permute(nanmean(Tempadnlf(100:255,110:156,:,:),1),[2 3 4 1]); % 100E-105W, 18N-65N
...
print(Fig,['E:\figures\IAP\Yearly\8yrs_nonlinearDetrend\IPO.corr.Pacific.zonalmean.tem.png'],'-dpng','-r600')
%% Atlantic
TemAtl = cat(1,Tempadnlf(255:360,:,:,:),Tempadnlf(1:20,:,:,:));
...
print(Fig,['E:\figures\IAP\Yearly\8yrs_nonlinearDetrend\IPO.corr.Atlantic.zonalmean.tem.png'],'-dpng','-r600')
%% meridional mean 
meridionalmean(Tempadnlf,Temp,latData,[50:111],'40S-20N',TPI_filtered,lonData,depthData);
%%
meridionalmean(Tempadnlf,Temp,latData,[20:40],'70S-50S',TPI_filtered,lonData,depthData);
%%
meridionalmean(Tempadnlf,Temp,latData,[40:60],'50S-30S',TPI_filtered,lonData,depthData);
%%
meridionalmean(Tempadnlf,Temp,latData,[60:116],'30S-25N',TPI_filtered,lonData,depthData);
%%
meridionalmean(Tempadnlf,Temp,latData,[116:141],'25N-50N',TPI_filtered,lonData,depthData);
%% different depth
%
diffdepth(Tempadnlf,1,TPI_filtered,lonData,latData,'0000')
%
diffdepth(Tempadnlf,7,TPI_filtered,lonData,latData,'0050')
diffdepth(Tempadnlf,12,TPI_filtered,lonData,latData,'0100')
diffdepth(Tempadnlf,17,TPI_filtered,lonData,latData,'0200')
diffdepth(Tempadnlf,23,TPI_filtered,lonData,latData,'0500')
diffdepth(Tempadnlf,29,TPI_filtered,lonData,latData,'0800')
diffdepth(Tempadnlf,32,TPI_filtered,lonData,latData,'1000')
diffdepth(Tempadnlf,37,TPI_filtered,lonData,latData,'1500')
diffdepth(Tempadnlf,41,TPI_filtered,lonData,latData,'2000')
...
function meridionalmean(Tempadnlf,Temp,latData,lats,names,index,lonData,depthData)
    latm = latmean(Tempadnlf,lats,latData);
    ...
    print(Fig,['E:\figures\IAP\Yearly\8yrs_nonlinearDetrend\IPO.corr.meridionalmean',names,'.tem.png'],'-dpng','-r600')
end
function diffdepth(Tempadnlf,nlevel,index,lonData,latData,names)
    Tsdf = reshape(Tempadnlf(:,:,nlevel,:),[360*180,73]);  % sst
    clear par11 h05
    parfor i = 1:360*180;
    ...
    print(Fig,['E:\figures\IAP\Yearly\8yrs_nonlinearDetrend\TPIcorrT',names,'m.png'],'-dpng','-r600')
end
