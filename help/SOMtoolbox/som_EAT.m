...
% close all;
% clc;
addpath G:\1_matlab\help\SOMtoolbox\somtoolbox2_Mar_17_2005\somtoolbox;
...
%  Choose the study area ---£¨120-160E£¬30-65N£©
sla = sla0(121:137,11:25,:);
nx = size(sla,1); ny = size(sla,2);
ns = nx*ny;
nt = size(sla,3);
