...
set(gca,'YTickLabel',[2000:-400:0],'FontSize',14);
ylabel('Depth (m)')
print(Fig,['/Users/yysong/Desktop/figures/EN4.2.1/Yearly/20240508_SO_warming/meridionalmean_',latstr,'_trend_',yrstr,'_150E.png'],'-dpng','-r300')
...
print(Fig,['/Users/yysong/Desktop/figures/EN4.2.1/Yearly/20240508_SO_warming/OHC',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.3.png'],'-dpng','-r300')
%% Global plot
close all;
ftsz = 12; ticks = 15;
