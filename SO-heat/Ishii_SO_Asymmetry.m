...
ylabel('Depth (m)')
print(Fig,['/Volumes/Togo4T/figures/Ishii/Yearly/20240705_SO_warming/Tem_meridionalmean_',latstr,'_trend_',yrstr,'.png'],'-dpng','-r300')
%% 150 longitude
close all;
ftsz = 20;
ticks = 0.1;
...
ylabel('Depth (m)')
print(Fig,['/Users/yysong/Desktop/figures/Ishii/Yearly/20240705_SO_warming/Tem_meridionalmean_',latstr,'_trend_',yrstr,'_150E.png'],'-dpng','-r300')
%% OHC
cp = 4096 % J (kg oC)
ro = 1025 % kg m-3
%------------------------- 0-2000m -----------------------------------------
...
print(Fig,['/Users/yysong/Desktop/figures/Ishii/Yearly/20240622_SO_warming/OHC',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.3.png'],'-dpng','-r300')
%% Global plot
close all;
ftsz = 12; ticks = 15;
