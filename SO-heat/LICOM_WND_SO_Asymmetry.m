...
filename1 = '/Volumes/Togo4T/data/LICOMpost/Tem_2000m.era5.WND.grid.nc';
...
ylabel('Depth (m)')
print(Fig,['/Users/yysong/Desktop/figures/LICOM/Yearly/20240705_SO_warming/WND_Tem.meridionalmean_',latstr,'_trend_',yrstr,'_150E.png'],'-dpng','-r300')
%% OHC
cp = 4096 % J (kg oC)
ro = 1025 % kg m-3
%------------------------- 0-2000m -----------------------------------------
...
print(Fig,['/Users/yysong/Desktop/figures/LICOM/Yearly/20240622_SO_warming/WND_OHC',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.3.png'],'-dpng','-r300')
...
legend('boxoff')
print(Fig,['/Users/yysong/Desktop/figures/LICOM/Yearly/20240622_SO_warming/WND_TimeSeries_OHC_GJm2_',depthstr,'_35S_55S_160W.png'],'-dpng','-r300')
%% net heat flux
