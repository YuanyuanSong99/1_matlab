...
datadir2='E:\CESM-post\LE\VSUBM\'; %指定批量数据所在的文件夹
...
yyaxis left
set(gca,'YLim',[ymin,ymax],'YTick',[ymin:yint:ymax],'YColor',clor);
print(Fig,['D:\figures\CESM\Yearly\LE\0_LEM\20240120_SO_Warming\MOHT_VSUBM_',regstr2,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
%% MOHT/dlon 
dlon = 300-splon;
...
print(Fig,['D:\figures\CESM\Yearly\LE\0_LEM\20240120_SO_Warming\MOHTdlon_VSUBM_',regstr2,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
%% dMOHT/dy
dlon = 300-splon; regstr = 'Pac';
dMdy = dMOHTdy(MOHTp);
dMdycli = dMOHTdy(MOHTcp);
ymin1 = -1.2; ymax1 = 1.2;  ymin2 = -.9; ymax2 = .9;
ymin3 = -.24; ymax3 = .24;  ymin4 = -.15; ymax4 = .15;
% 
...
ymin1 = -3; ymax1 = 3;  ymin2 = -3; ymax2 = 3;
ymin3 = -.24; ymax3 = .24;  ymin4 = -.15; ymax4 = .15;
% % % % % %
...
print(Fig,['D:\figures\CESM\Yearly\LE\0_LEM\20240120_SO_Warming\MOHTdydlon_VSUBM_',regstr,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
% dMOHT/dy
% close all;
Fig = figure('position',[100 100 800 400])
...
print(Fig,['D:\figures\CESM\Yearly\LE\0_LEM\20240120_SO_Warming\MOHTdy_VSUBM_',regstr,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
