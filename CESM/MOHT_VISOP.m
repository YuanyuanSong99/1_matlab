...
% historical 
datadir1='E:\CESM-post\LE\TEMP\historical\'; %指定批量数据所在的文件夹
filelist1=dir([datadir1,'*.nc']); %指定批量数据的类型
ncdisp([datadir1,filelist1(1).name]);
datadir2='E:\CESM-post\LE\VISOP\'; %指定批量数据所在的文件夹
...
yyaxis left
set(gca,'YLim',[ymin,ymax],'YTick',[ymin:yint:ymax],'YColor',clor);
print(Fig,['D:\figures\CESM\Yearly\LE\0_LEM\20240120_SO_Warming\MOHT_VISOP_',regstr2,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
%% MOHT/dlon 
dlon = 300-splon;
...
print(Fig,['D:\figures\CESM\Yearly\LE\0_LEM\20240120_SO_Warming\MOHTdlon_VISOP_',regstr2,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
%% dMOHT/dy
dlon = 300-splon; regstr = 'Pac';
dMdy = dMOHTdy(MOHTp);
dMdycli = dMOHTdy(MOHTcp);
ymin1 = -12; ymax1 = 12;  ymin2 = -4.8; ymax2 = 4.8;
ymin3 = -2.4; ymax3 = 2.4;  ymin4 = -.9; ymax4 = .9;
% 
...
ymin1 = -30; ymax1 = 30;  ymin2 = -9; ymax2 = 9;
ymin3 = -2.4; ymax3 = 2.4;  ymin4 = -.9; ymax4 = .9;
% % % % % %
...
print(Fig,['D:\figures\CESM\Yearly\LE\0_LEM\20240120_SO_Warming\MOHTdydlon_VISOP_',regstr,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
% dMOHT/dy
% close all;
Fig = figure('position',[100 100 800 400])
...
print(Fig,['D:\figures\CESM\Yearly\LE\0_LEM\20240120_SO_Warming\MOHTdy_VISOP_',regstr,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
