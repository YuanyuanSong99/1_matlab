...
ZOHTem = permute(nansum(OHCzy(:,30:55,:),2),[1 3 2]); % all
...
plot(300*ones(11),[0:4/10:4],'-','color','k','linewidth',2)
...
print(Fig,['/Users/yysong/Desktop/figures/CESM/Yearly/LE/0_LEM/20240503_SO_warming/ZOHTensmean_trend.png'],'-dpng','-r300')
%% zoht anomaly time series 145-150E, 65-60W
ln1 = mean(ZOHTem(146:151,41:101),1); %1960-2020
ln2 = mean(ZOHTem(296:301,41:101),1); %1960-2020
% p1 = ln1(41:101)-mean(ln1(41:101)); % baseline 1960-2020
% p2 = ln2(41:101)-mean(ln2(41:101)); % baseline 1960-2020
yb1 = polyfit([1:61],ln1/10^15,1);
yb2 = polyfit([1:61],ln2/10^15,1);

close all;
Fig = figure('position',[100 100 800 400]);
plot(ln1/10^15,'-','color','b','linewidth',2)
hold on
plot(ln2/10^15,'-','color','r','linewidth',2)
plot(zeros(61),'-','color','k','linewidth',1)

set(gca,'XLim',[1,61]);set(gca,'XTick',[1:10:61]);
set(gca,'XTickLabel',[1960:10:2020],'FontSize',14);
set(gca,'YLim',[.8,1.4],'YTick',[.8:.2:1.4]);
ylabel('ZOHT (PW)');xlabel('Longitude')
legend(['Indian Ocean to Pacific (Trend ',num2str(roundn(yb1(1),-4)),')'],...
    ['Pacific to Atlantic (Trend ',num2str(roundn(yb2(1),-4)),')'],'location','northwest','fontsize',14)
legend('boxoff')
print(Fig,['/Users/yysong/Desktop/figures/CESM/Yearly/LE/0_LEM/20240503_SO_warming/ZOHTensmean_145E-150E_65W-60W.png'],'-dpng','-r300')
%% UNT trend 2d
startyr = 1960;
endyr = 2005;
lats = 1:90;
