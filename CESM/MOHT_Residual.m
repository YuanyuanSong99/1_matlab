...
endyr = 2020;
lats = [20:60];
var1 = MOHTp(lats,startyr-1919:endyr-1919)';
...
map1 = trd1/(140*elon); regstr = 'Pac_150-70W'
map2 = trd2/(210*elon); regstr = 'AtlIO_70W-150E'
map1c = cli1/(140*elon);
map2c = cli2/(210*elon);
% map = trd3/(90*elon); regstr = 'IO_30E-120E'
close all;
Fig = figure('position',[700 100 800 400]);
ymax1 = 80; ymin1 = -40; yint1 = 20; 
ymax2 = 80; ymin2 = -40; yint2 = 20; 
p1 = plot(latData(20:60),map1/10^3,'-','color',[.04 .35 .56],'LineWidth',3);
hold on
p2 = plot(latData(20:60),map2/10^3,'-','color',[.64 .08 .18],'LineWidth',3);
...
yyaxis right
p3 = plot(latData(20:60),map1c/10^6,'--','color',[.04 .35 .56],'LineWidth',1.5);
hold on
p4 = plot(latData(20:60),map2c/10^6,'--','color',[.64 .08 .18],'LineWidth',1.5);
set(gca,'YLim',[ymin2,ymax2],'YTick',[ymin2:yint2:ymax2],'ycolor','k');
ylabel('Climo  (10^3 kW m^-^1)','FontSize',14,'Color','k');
...
% print(Fig,['/Users/yysong/Desktop/figures/CESM/Yearly/LE/0_LEM/20240503_SO_Warming/MOHT_VRES_',regstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
% 手动哦保存
%% dMOHT/dy m-1
...
% map1 = trd2/(210*elon); 
% map2 = cli2/(210*elon);
ymin1 = -.24; ymax1 = .18; yint = .06
ymin2 = -100; ymax2 = 75; yint2 = 25
latd = latData(lats);
close all;
...
set(gca,'XLim',[-70.5,-30.5],'XTick',[-70.5:10:-30.5],'XTickLabel',{'70^oS','60^oS','50^oS','40^oS','30^oS'},'FontSize',14,'XGrid','on','YGrid','on');
xlabel('Latitude','FontSize',14),ylabel('Trend (W m^-^2 yr^-^1)','FontSize',14);
...
set(gca,'YLim',[ymin2,ymax2],'YTick',[ymin2:yint2:ymax2],'ycolor','k');
ylabel('Climo (W m^-^2)','FontSize',14);
legend([h1, h2],'Divergence trend','Convergence trend','Location','northwest','edgecolor','w')

% print(Fig,['/Users/yysong/Desktop/figures/CESM/Yearly/LE/0_LEM/20240503_SO_Warming/MOHTdydx_',regstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
% 手动保存
%% VISOP
% historical 
...
%
save(['MatFile/MOHT_150E_70W_700m/VVELc.mat'],'VVELc');
save(['MatFile/MOHT_150E_70W_700m/VVELtrd.mat'],'VVELtrd');
save(['MatFile/MOHT_150E_70W_700m/VVELt.mat'],'VVELt');
save(['MatFile/MOHT_150E_70W_700m/VISOPc.mat'],'VISOPc');
save(['MatFile/MOHT_150E_70W_700m/VISOPtrd.mat'],'VISOPtrd');
save(['MatFile/MOHT_150E_70W_700m/VISOPt.mat'],'VISOPt');
save(['MatFile/MOHT_150E_70W_700m/VSUBMc.mat'],'VSUBMc');
save(['MatFile/MOHT_150E_70W_700m/VSUBMtrd.mat'],'VSUBMtrd');
save(['MatFile/MOHT_150E_70W_700m/VSUBMt.mat'],'VSUBMt');


%% load
load(['MatFile/MOHT_150E_70W_700m/VVELc.mat'],'VVELc');
load(['MatFile/MOHT_150E_70W_700m/VVELtrd.mat'],'VVELtrd');
load(['MatFile/MOHT_150E_70W_700m/VVELt.mat'],'VVELt');
load(['MatFile/MOHT_150E_70W_700m/VISOPc.mat'],'VISOPc');
load(['MatFile/MOHT_150E_70W_700m/VISOPtrd.mat'],'VISOPtrd');
load(['MatFile/MOHT_150E_70W_700m/VISOPt.mat'],'VISOPt');
load(['MatFile/MOHT_150E_70W_700m/VSUBMc.mat'],'VSUBMc');
load(['MatFile/MOHT_150E_70W_700m/VSUBMtrd.mat'],'VSUBMtrd');
load(['MatFile/MOHT_150E_70W_700m/VSUBMt.mat'],'VSUBMt');
%%
