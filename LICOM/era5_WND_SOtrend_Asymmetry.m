% era5 forcing Data 
clc,clear,close all;
addpath(genpath('F:\1_matlab\help'));
...
%
filename1 = 'F:\data\LICOM\Tem_2000m.era5.WND.grid.nc';
...
print(Fig,['D:\figures\LICOM\Yearly\20231201\era5.Tem',depthstr,'m_trend_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
%% meridional mean
lats = 35:55; % 55S-35S
latstr = '35S_55S';
...
load('F:/1_matlab/help/colorbar_mat/bl_re4.mat');
...
ylabel('Depth (m)')
print(Fig,['D:\figures\LICOM\Yearly\20240105_SO_warming\windforcing\Tem.meridionalmean_',latstr,'_trend_',yrstr,'_180E.1.png'],'-dpng','-r300')
%% 150 longitude
close all;
ftsz = 12;
ticks = 0.15;
...
set(gca,'YTickLabel',[2000:-400:0],'FontSize',14);
ylabel('Depth (m)')
print(Fig,['D:\figures\LICOM\Yearly\20240105_SO_warming\windforcing\Tem.meridionalmean_',latstr,'_trend_',yrstr,'_150E.2.png'],'-dpng','-r300')
%% OHC
cp = 4096 % J (kg oC)
ro = 1025 % kg m-3
%------------------------- 0-2000m -----------------------------------------
...
print(Fig,['D:\figures\LICOM\Yearly\20240105_SO_warming\windforcing\OHC',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.3.png'],'-dpng','-r300')
...
%%
% IAP square
datadir='F:\data\IAP\temperature\Yearly\'; %指定批量数据所在的文件夹
...
aa = load("F:\1_matlab\IAP\MatFile\lonData.mat"); lonData_i = aa.lonData;
aa = load("F:\1_matlab\IAP\MatFile\latData.mat"); latData_i = aa.latData;
aa = load("F:\1_matlab\IAP\MatFile\depthData.mat"); depthData_i = aa.depthData;
...
legend('boxoff')
print(Fig,['D:\figures\LICOM\Yearly\20240105_SO_warming\windforcing\TimeSeries_OHC_GJm2_',depthstr,'_35S_55S_150E.png'],'-dpng','-r300')
%% zonal OHC
lonstr = 150;
startyr = 1960;
endyr = 2020;
...
yyaxis left
set(gca,'YLim',[ymin,ymax],'YTick',[ymin:yint:ymax],'YColor',clor);
print(Fig,['D:\figures\LICOM\Yearly\20240425_SO_warming\OHCzonal_',regstr2,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'WND.png'],'-dpng','-r300')
%% zonal OHC /m2
lonstr = 150;
startyr = 1960;
endyr = 2020;
...
yyaxis left
set(gca,'YLim',[ymin,ymax],'YTick',[ymin:yint:ymax],'YColor',clor);
print(Fig,['D:\figures\LICOM\Yearly\20240425_SO_warming\OHCm2_zonal_',regstr2,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'WND.png'],'-dpng','-r300')

%% net heat flux
startyr = 1960; endyr = 2020;
[nhflx lonData latData] = read_1lev_1nc('I:\LICOM\WND\YEARMEAN\net1_yrmean.nc','net1');
...
print(Fig,['D:\figures\LICOM\Yearly\20240423_SO_warming\era5.WND.',varname,'_trend_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
% [Fig] = pltrdpolar(mean(var(:,:,startyr-1940:endyr-1940),3),100,lonData,latData,12,unit)
% print(Fig,['D:\figures\LICOM\Yearly\20240423_SO_warming\era5.WND.',varname,'_climo_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
%% latent heat flux
startyr = 1960; endyr = 2020;
[lthf lonData latData] = read_1lev_1nc('I:\LICOM\WND\YEARMEAN\lthf_yrmean.nc','lthf');
...
%% sensible heat flux
startyr = 1960; endyr = 2020;
[sshf lonData latData] = read_1lev_1nc('I:\LICOM\WND\YEARMEAN\sshf_yrmean.nc','sshf');
...
%% long wave
startyr = 1960; endyr = 2020;
[lwv lonData latData] = read_1lev_1nc('I:\LICOM\WND\YEARMEAN\lwv_yrmean.nc','lwv');
var = lwv; varname = 'LWV'; 
zlim = 4; unit = 'W m^-^2 decade^-^1';
[trd h0] = lntrend3d(var(:,:,startyr-1940:endyr-1940),0.05);
max(trd,[],'all')
...
%% short wave
startyr = 1960; endyr = 2020;
[swv lonData latData] = read_1lev_1nc('I:\LICOM\WND\YEARMEAN\swv_yrmean.nc','swv');
var = swv; varname = 'SWV'; 
zlim = 4; unit = 'W m^-^2 decade^-^1';
[trd h0] = lntrend3d(var(:,:,startyr-1940:endyr-1940),0.05);
max(trd,[],'all')
...
print(Fig,['D:\figures\LICOM\Yearly\20240425_SO_warming\',namestr,'zonal_',regstr2,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'WND.png'],'-dpng','-r300')
%% MOHT
% cal vt
[ts] = read_nlev_1nc('F:\data\LICOM\Tem_2000m.era5.WND.grid.nc','ts');
[vs] = read_nlev_1nc('I:\LICOM\WND\YEARMEAN\vs_yrmean.nc','vs');
vs = vs(:,:,:,1:82);
%%
...
print(Fig,['D:\figures\LICOM\Yearly\20240425_SO_warming\MOHTdlon_',regstr2,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.WND.png'],'-dpng','-r300')
%% dMOHT/dy m-1
...
print(Fig,['D:\figures\LICOM\Yearly\20240425_SO_warming\MOHTdydx_VRES_',regstr,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'WND.png'],'-dpng','-r300')
...
% filename = 'F:\data\NOAA\20CRv3\20thC_ReanV3\Monthlies\miscSI-MO\prmsl.mon.mean.nc'; % 1836-2015
