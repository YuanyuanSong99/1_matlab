...
%
filename1 = '/Volumes/Togo/data/LICOM/Tem_2000m.era5.HEAT.grid.nc';
...
ylabel('Depth (m)')
print(Fig,['D:/figures/LICOM/Yearly/20240105_SO_warming/heatforcing/Tem.meridionalmean_',latstr,'_trend_',yrstr,'_180E.2.png'],'-dpng','-r300')
%% 150 longitude
close all;
ftsz = 12;
ticks = 0.1;
...
set(gca,'YTickLabel',[2000:-400:0],'FontSize',14);
ylabel('Depth (m)')
print(Fig,['D:/figures/LICOM/Yearly/20240105_SO_warming/heatforcing/Tem.meridionalmean_',latstr,'_trend_',yrstr,'_150E.1.png'],'-dpng','-r300')
%% OHC
cp = 4096 % J (kg oC)
ro = 1025 % kg m-3
%------------------------- 0-2000m -----------------------------------------
...
print(Fig,['D:/figures/LICOM/Yearly/20240105_SO_warming/heatforcing/OHC',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.3.png'],'-dpng','-r300')
...
%%
% IAP square
datadir='D:/data/IAP/temperature/Yearly/'; %指定批量数据所在的文件夹
...
aa = load("D:/1_matlab/IAP/MatFile/lonData.mat"); lonData_i = aa.lonData;
aa = load("D:/1_matlab/IAP/MatFile/latData.mat"); latData_i = aa.latData;
aa = load("D:/1_matlab/IAP/MatFile/depthData.mat"); depthData_i = aa.depthData;
...
legend('boxoff')
print(Fig,['D:/figures/LICOM/Yearly/20240105_SO_warming/heatforcing/TimeSeries_OHC_GJm2_',depthstr,'_35S_55S_160W.png'],'-dpng','-r300')
%% zonal OHC
lonstr = 150;
startyr = 1960;
endyr = 2020;
...
yyaxis left
set(gca,'YLim',[ymin,ymax],'YTick',[ymin:yint:ymax],'YColor',clor);
print(Fig,['D:/figures/LICOM/Yearly/20240425_SO_warming/OHCzonal_',regstr2,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'HEAT.png'],'-dpng','-r300')
%% zonal OHC /m2
lonstr = 150;
startyr = 1960;
endyr = 2020;
...
yyaxis left
set(gca,'YLim',[ymin,ymax],'YTick',[ymin:yint:ymax],'YColor',clor);
print(Fig,['D:/figures/LICOM/Yearly/20240425_SO_warming/OHCm2_zonal_',regstr2,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'HTFL.png'],'-dpng','-r300')
%% net heat flux
startyr = 1960; endyr = 2020;
[nhflx lonData latData] = read_1lev_1nc('I:/LICOM/HTFL/YEARMEAN/net1_yrmean.nc','net1');
...
print(Fig,['D:/figures/LICOM/Yearly/20240423_SO_warming/era5.HTFL.',varname,'_trend_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
% [Fig] = pltrdpolar(mean(var(:,:,startyr-1940:endyr-1940),3),100,lonData,latData,12,unit)
% print(Fig,['D:/figures/LICOM/Yearly/20240423_SO_warming/era5.HTFL.',varname,'_climo_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
%% latent heat flux
startyr = 1960; endyr = 2020;
[lthf lonData latData] = read_1lev_1nc('I:/LICOM/HTFL/YEARMEAN/lthf_yrmean.nc','lthf');
...
%% sensible heat flux
startyr = 1960; endyr = 2020;
[sshf lonData latData] = read_1lev_1nc('I:/LICOM/HTFL/YEARMEAN/sshf_yrmean.nc','sshf');
...
%% long wave
startyr = 1960; endyr = 2020;
[lwv lonData latData] = read_1lev_1nc('I:/LICOM/HTFL/YEARMEAN/lwv_yrmean.nc','lwv');
var = lwv; varname = 'LWV'; 
zlim = 4; unit = 'W m^-^2 decade^-^1';
[trd h0] = lntrend3d(var(:,:,startyr-1940:endyr-1940),0.05);
max(trd,[],'all')
...
%% short wave
startyr = 1960; endyr = 2020;
[swv lonData latData] = read_1lev_1nc('I:/LICOM/HTFL/YEARMEAN/swv_yrmean.nc','swv');
var = swv; varname = 'SWV'; 
zlim = 4; unit = 'W m^-^2 decade^-^1';
[trd h0] = lntrend3d(var(:,:,startyr-1940:endyr-1940),0.05);
max(trd,[],'all')
...
print(Fig,['D:/figures/LICOM/Yearly/20240425_SO_warming/',namestr,'zonal_',regstr2,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'HTFL.png'],'-dpng','-r300')
%% MOHT
% cal vt
[ts] = read_nlev_1nc('E:/data/LICOM/Tem_2000m.era5.HEAT.grid.nc','ts');
[vs] = read_nlev_1nc('I:/LICOM/HTFL/YEARMEAN/vs_yrmean.nc','vs');
vs = vs(:,:,:,1:82);
%%
...
print(Fig,['D:/figures/LICOM/Yearly/20240425_SO_warming/MOHTdlon_',regstr2,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.HTFL.png'],'-dpng','-r300')
%% dMOHT/dy m-1
...
print(Fig,['D:/figures/LICOM/Yearly/20240425_SO_warming/MOHTdydx_VRES_',regstr,'_',lonstr,'_',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'HTFL.png'],'-dpng','-r300')
