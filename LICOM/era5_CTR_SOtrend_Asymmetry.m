...
filename1 = '/Volumes/Togo4T/data/LICOM/Tem_2000m.era5.grid.nc';
...
lats = 1:60;
T700 = Tem1(:,:,21,:)+(Tem1(:,:,22,:)-Tem1(:,:,21,:))*(700-depthData(21))/(depthData(22)-depthData(21));
...
print(Fig,['/Users/yysong/Desktop/figures/LICOM/Yearly/20231201/era5.Tem',depthstr,'m_trend_',num2str(startyr),'_',num2str(endyr),'.png'],'-dpng','-r300')
%% meridional mean
lats = 35:55; % 55S-35S
latstr = '35S_55S';
...
ylabel('Depth (m)')
print(Fig,['/Users/yysong/Desktop/figures/LICOM/Yearly/20240508_SO_warming/allforcing/Tem.meridionalmean_',latstr,'_trend_',yrstr,'.2.png'],'-dpng','-r300')
%% 150 longitude
close all;
ftsz = 12;
ticks = 0.1;
...
set(gca,'YTickLabel',[2000:-400:0],'FontSize',14);
ylabel('Depth (m)')
print(Fig,['/Users/yysong/Desktop/figures/LICOM/Yearly/20240508_SO_warming/allforcing/Tem.meridionalmean_',latstr,'_trend_',yrstr,'_150E.1.png'],'-dpng','-r300')
%% OHC
cp = 4096 % J (kg oC)
ro = 1025 % kg m-3
%------------------------- 0-2000m -----------------------------------------
...
print(Fig,['/Users/yysong/Desktop/figures/LICOM/Yearly/20240508_SO_warming/allforcing/OHC',depthstr,'_trend_',num2str(startyr),'_',num2str(endyr),'.3.png'],'-dpng','-r300')
...
spac_0 = cp*ro*squeeze(nansum(nansum(nansum(Tzyxsub_r_0(1:290-lons,lats,levs,:),1),2),3));
spacS = squeeze(nansum(nansum(Vzyxsub_r_0(1:290-lons,lats,1),1),2)); % Square
spac0S = spac_0./spacS;
sia_0 = cp*ro*squeeze(nansum(nansum(nansum(Tzyxsub_r_0(290-lons+1:360,lats,levs,:),1),2),3));
siaS = squeeze(nansum(nansum(Vzyxsub_r_0(290-lons+1:360,lats,1),1),2)); % Square
sia0S = sia_0./siaS;
...
aa = load("/Volumes/Togo4T/1_matlab/IAP/MatFile/lonData.mat"); lonData_i = aa.lonData;
aa = load("/Volumes/Togo4T/1_matlab/IAP/MatFile/latData.mat"); latData_i = aa.latData;
aa = load("/Volumes/Togo4T/1_matlab/IAP/MatFile/depthData.mat"); depthData_i = aa.depthData;
...
Vzyxsub_r_0 = cat(1,VVzyx(lons+1:360,:,:),VVzyx(1:lons,:,:)); 
spacS_i = squeeze(nansum(nansum(Vzyxsub_r_0(1:290-lons,lats,1),1),2)); % Square
siaS_i = squeeze(nansum(nansum(Vzyxsub_r_0(290-lons+1:360,lats,1),1),2)); % Square
...
legend('boxoff')
print(Fig,['/Users/yysong/Desktop/figures/LICOM/Yearly/20240508_SO_warming/allforcing/TimeSeries_OHC_GJm2_',depthstr,'_35S_55S_160W.png'],'-dpng','-r300')
%% zonal OHC
lonstr = 150;
startyr = 1960;
endyr = 2020;
